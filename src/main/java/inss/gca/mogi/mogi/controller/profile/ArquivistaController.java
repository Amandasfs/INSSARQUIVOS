...
public class ArquivistaController {
    ...
    @FXML private TableColumn<BuscaDTO, String> colCpf;
    ...
    // redirecionamentos
    public void handleAltPass(MouseEvent mouseEvent) {
        abrirTela("/update/AlterarSenha.fxml", "TROCAR SENHA");
    }

    public void handleCadCaixa(MouseEvent mouseEvent) {
        abrirTela("/create/CriarCaixa.fxml", "CADASTRAR CAIXA");
    }

    public void handleAltCaixa(MouseEvent mouseEvent) {
        abrirTela("/select/SelectAltCaixa.fxml", "ALTERAR CAIXA");
    }

    public void handleCadArqui(MouseEvent mouseEvent) {
        abrirTela("/select/SelectCadArquivo.fxml", "CADASTRAR ARQUIVO");
    }

    public void handleAltArqui(MouseEvent mouseEvent) {
